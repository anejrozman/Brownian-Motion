...
\izvlecek{
    ...
    Predstavimo in doka"zemo nekaj osnovnih lastnosti ter rezultatov, kot je simetričnost Brownovega gibanja, krepka lastnost Markova,
...
\abstract{
    ...
    We present and prove some basic properties and results, such as the symmetry of Brownian motion, strong Markov property,
...
\bibitem{2} Tukej bo vir do dokaza za dokaz pomoznih trditev za krepko lastnost markova 
\bibitem{3} M. Perman, \emph{Zapiski predavanj finan"cne matematike 2} 2021
\bibitem{4} S. Karlin in H. M. Taylor, \emph{A First Course in Stochastic Processes}, Academic Press, 1975.
