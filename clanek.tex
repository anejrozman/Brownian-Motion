...
\begin{dokaz}
    Naj bo $t \geq 0$. Zaradi neodivsnoti prirastkov sta slu"cajni spremenljivki 
    $$
...
\begin{opomba}
    Zgornjemu izreku pravimo tudi "sibka lastnost Markova. Med drugim iz tega sledi, da je Brownovo giabnje Markovski proces.
\end{opomba}

Vpra"sanje ki se pojavi je, Kaj pa "ce naklju"cno ustavimo proces. A zgornja lastnost "se vedno velja?
...
\bibitem{2} M. Perman, \emph{Zapiski predavanj finan"cne matematike 2}, spletni vir dostopen na \href{http://valjhun.fmf.uni-lj.si} izr. prof. dr. M. Permana (zadni"c dostopano januar 2024).
